...
namespace libDSI54.BaseDatos
{
    public class clsCliente
    {
        ...
        {
            get { return iCodigoCliente; }
            set { iCodigoCliente = value; }
        }
        ...
        {
            sSQL = " INSERT INTO tblCliente " +
                   " (Documento, Nombre, Apellidos, Direccion, Telefono, email) " +
